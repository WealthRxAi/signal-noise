...
![The terminal](signal-noise/docs/hero.png)

> Source, migrations and tests live in [`signal-noise/`](signal-noise).
...
- [`supabase/migrations/0001_init.sql`](signal-noise/supabase/migrations/0001_init.sql) — tables, RLS, the treemap and lab-race views
- [`supabase/migrations/0002_semantic_and_scorecard.sql`](signal-noise/supabase/migrations/0002_semantic_and_scorecard.sql) — pgvector, the merge functions, the outlet scorecard
...
MIT — see [LICENSE](signal-noise/LICENSE).
